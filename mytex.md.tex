...
\newcommand{\deriv}[3][{}]{\f{\d{^{#1}#2}}{\d{#3^{#1}}}}
...
\newcommand{\ce}[3][{}]{\e[#1]{#2\ \m|\ #3}}
\newcommand{\var}[1]{\mathrm{Var}\!\l[#1\r]}
\newcommand{\cvar}[2]{\var{#1\ \m|\ #2}}
\newcommand{\sd}[1]{\mathrm{SD}\!\l[#1\r]}
\newcommand{\cov}[2]{\mathrm{Cov}\!\l[#1,#2\r]}
